...
**Translate Me** is an app that uses LLMs to translate on iOS
...
Add real time messaging with the translations
Allow LLMs to perform the translations
Ensure compatability with older iOS devices
